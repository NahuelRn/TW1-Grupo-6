...
public class ServicioUsuarioImpl implements ServicioUsuario {
    ...
    public ServicioUsuarioImpl(RepositorioUsuario REPOSITORIO_USUARIO, RepositorioCarta REPOSITORIO_CARTA, RepositorioInventario REPOSITORIO_INVENTARIO, ServicioCalculoRecompensa servicioCalculoRecompensa) {
    ...
    private void procesarCarta(Usuario usuario, RecompensaDTO dto) {
        ...
        ItemInventario itemInventario = REPOSITORIO_INVENTARIO.buscarItemDeJugador(usuario.getId(), carta.getId());
